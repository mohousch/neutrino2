...
int CDBoxInfoWidget::exec(CTarget *parent, const std::string &actionKey)
{
...
int CInfoMenu::showMenu()
{
	...
	else
	{
		...
		infoMenu->setMode(ClistBox::MODE_MENU);
		infoMenu->setLayout(ClistBox::LAYOUT_STANDARD);
		...
		//
		infoMenu->addPluginItem("systeminfo", CRCInput::RC_blue, NEUTRINO_ICON_BUTTON_BLUE);
	}

...
void CMainSettingsMenu::showMenu(void)
{
	...
	mainSettings->addItem(new ClistBoxItem(_("Pictureviewer settings"), true, NULL, new CPictureViewerSettings(), NULL, RC_nokey, NULL, NEUTRINO_ICON_MENUITEM_PICTUREVIEWERSETTINGS));

...
int CPictureViewerGui::exec(CTarget* parent, const std::string &actionKey)
{
...
void CPictureViewerGui::showHelp()
{
	...
	helpbox->addLine(_("Display image"), NEUTRINO_ICON_BUTTON_OKAY);
	helpbox->addLine(_("Do not scale picture"), NEUTRINO_ICON_BUTTON_0);
	helpbox->addLine(_("Change sort order"), NEUTRINO_ICON_BUTTON_5);
	helpbox->addSeparator();
	helpbox->addLine(_("Diashow mode"));
	helpbox->addLine(_("Previous image"), NEUTRINO_ICON_BUTTON_LEFT);
	helpbox->addLine(_("Next image"), NEUTRINO_ICON_BUTTON_RIGHT);
	helpbox->addLine(_("Change sort order"), NEUTRINO_ICON_BUTTON_5);
	helpbox->addLine(_("Exit"), NEUTRINO_ICON_BUTTON_HOME);
	helpbox->addSeparator();
	helpbox->addLine(_("Show mode"));
	helpbox->addLine(_("Reread image"), NEUTRINO_ICON_BUTTON_OKAY);
	helpbox->addLine(_("Previous image"), NEUTRINO_ICON_BUTTON_LEFT);
	helpbox->addLine(_("Next image"), NEUTRINO_ICON_BUTTON_RIGHT);
	helpbox->addLine(_("Reread image (no scaling)"), NEUTRINO_ICON_BUTTON_0);
	helpbox->addLine(_("Zoom out"), NEUTRINO_ICON_BUTTON_1);
	helpbox->addLine(_("Scroll up"), NEUTRINO_ICON_BUTTON_2);
	helpbox->addLine(_("Zoom in"), NEUTRINO_ICON_BUTTON_3);
	helpbox->addLine(_("Scroll left"), NEUTRINO_ICON_BUTTON_4);
	helpbox->addLine(_("Change sort order"), NEUTRINO_ICON_BUTTON_5);
	helpbox->addLine(_("Scroll right"), NEUTRINO_ICON_BUTTON_6);
	helpbox->addLine(_("Scroll down"), NEUTRINO_ICON_BUTTON_8);
	helpbox->addLine(_("Exit"), NEUTRINO_ICON_BUTTON_HOME);

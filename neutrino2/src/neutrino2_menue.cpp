...
//	
//	$Id: neutrino2_menue.cpp 21122024 mohousch Exp $
//
...
void CNeutrinoApp::mainMenu(void)
{
	...
	else
	{
		...
		nMenu->setWidgetType(ClistBox::TYPE_STANDARD);
		...
		item->setHintIcon(NEUTRINO_ICON_MENUITEM_OSD);
...
bool CNeutrinoApp::showUserMenu(int button)
{
	...
	else
	{
		...
		menu->setWidgetType(ClistBox::TYPE_STANDARD);

...
void * CZapit::scanTransponderThread(void * data)
{
	...
	CScan::getInstance()->addToScan(CREATE_TRANSPONDER_ID(freq, satellitePosition, CZapit::getInstance()->fake_nid, CZapit::getInstance()->fake_tid), &TP->feparams, false, feindex);

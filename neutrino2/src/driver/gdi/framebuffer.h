...
class CFrameBuffer
{
	...
	public:
		...
		void blitBox2FB(void * boxBuf, const uint32_t width, const uint32_t height, const uint32_t xoff, const uint32_t yoff, const uint32_t xp = 0, const uint32_t yp = 0, bool transp = false);

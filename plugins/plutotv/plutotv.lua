...
function cat_menu(_id)
	...
	cm:enablePaintDate()
	cm:clear()
	cm:setHeadCorner(neutrino2.RADIUS_SMALL)
	cm:setHeadGradient(neutrino2.DARK2LIGHT2DARK)
	cm:setHeadLine(false)
	cm:setFootCorner(neutrino2.RADIUS_SMALL)
	cm:setFootGradient(neutrino2.DARK2LIGHT2DARK)
	cm:setFootLine(false)
...
function episode_menu(s)
	...
	em:enablePaintDate()
	em:clear()
	em:setHeadCorner(neutrino2.RADIUS_SMALL)
	em:setHeadGradient(neutrino2.DARK2LIGHT2DARK)
	em:setHeadLine(false)
	em:setFootCorner(neutrino2.RADIUS_SMALL)
	em:setFootGradient(neutrino2.DARK2LIGHT2DARK)
	em:setFootLine(false)
